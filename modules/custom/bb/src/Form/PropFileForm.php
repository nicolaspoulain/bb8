...
/**
 * @file
 * Contains Drupal\bb\Form\PropFileForm.
 */
...
/**
 * Implements the PropFileForm form controller.
 */
class PropFileForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getTitle() {
    return 'Fichiers de proposition de stage (conseillers)';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['afile'] = array(
      ...
      '#required' => FALSE,
      // '#element_validate' => array( array($this, 'savePropFile'), ), // callback
    );
