...
/**
 * @file
 * Contains Drupal\offres\Form\CoeForm.
 */
...
/**
 * Implements the CoeForm form controller.
 */
class CoeForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getTitle() {
    return 'Modification de la coe';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $coe=NULL, $co_omodu=NULL) {

  $form['co_omodu']  = array('#type' => 'hidden','#value' => $co_omodu );
  $form['coe'] = array(
    '#type' => 'checkbox', '#size' => 1,
    '#default_value' => (isset($coe))? (int)$coe : '0',
    '#ajax' => array(
