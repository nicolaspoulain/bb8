...
/**
 * @file
 * Contains Drupal\offres\Form\AplForm.
 */
...
/**
 * Implements the AplForm form controller.
 */
class AplForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getTitle() {
    return 'Modification de la apl';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $apl=NULL, $co_omodu=NULL) {

  $form['co_omodu']  = array('#type' => 'hidden','#value' => $co_omodu );
  $form['apl'] = array(
    '#type' => 'checkbox', '#size' => 1,
    '#default_value' => (isset($apl))? (int)$apl : '0',
    '#ajax' => array(
